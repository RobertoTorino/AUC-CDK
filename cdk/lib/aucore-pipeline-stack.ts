...
export class AuCorePipelineStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: StackProps) {
    ...
    const auCoreCdkPipeline = new CodePipeline(this, 'AuCoreCdkPipeline', {
    ...
    auCoreCdkPipeline.addStage(auCoreStage, {
      pre: [
    ...
    auCoreCdkPipeline.buildPipeline();
    ...
    const pipelineRule = auCoreCdkPipeline.pipeline.notifyOn('PipelineEvents', slackChannelConfiguration, {
